...
class EncountersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create encounter" do
    assert_difference('Encounter.count') do
      post encounters_url, params: { encounter: { description: @encounter.description, title: @encounter.title } }
    end
  ...
  test "should update encounter" do
    patch encounter_url(@encounter), params: { encounter: { description: @encounter.description, title: @encounter.title } }
