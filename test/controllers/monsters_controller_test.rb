...
class MonstersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create monster" do
    assert_difference('Monster.count') do
      post monsters_url, params: { monster: { ac: @monster.ac, hp: @monster.hp, image: @monster.image, name: @monster.name, speed: @monster.speed } }
    end
  ...
  test "should update monster" do
    patch monster_url(@monster), params: { monster: { ac: @monster.ac, hp: @monster.hp, image: @monster.image, name: @monster.name, speed: @monster.speed } }
